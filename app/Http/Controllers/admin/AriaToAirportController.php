...
class AriaToAirportController extends Controller
{
    private $model;
    private $table;
    private $page;
    ...
    public function __construct()
    {
        ...
        $this->model = 'AriaToAirport';
        $this->table = 'aria_to_airports';
        $this->page = 'aria_to_airport';
        $this->url = 'aria_to_airport';
        $this->title = 'Aria To Airport Transfers';
    }

    public function add(Request $request, $id = Null)
    {
        $decrypted_id = get_decrypted_value($id, true);
        $category = AirportTransfer::where('status',1)->get();

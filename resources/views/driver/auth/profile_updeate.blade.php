                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="email" name="user_email" value="{{ old('email',isset($profile->email) ? $profile->email : '' )}}" class="form-control" id="formrow-email-input" placeholder="Enter Your Email ID">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">

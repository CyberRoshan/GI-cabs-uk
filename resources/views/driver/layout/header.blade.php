...
<head>
    ...
    <!-- ico font -->
    <link rel="stylesheet" href="https://cdn.datatables.net/1.13.4/css/dataTables.bootstrap4.min.css" type="text/css" media="all">
    <link rel="stylesheet" type="text/css" href="{{url('/public/admin/')}}/assets/icon/icofont/css/icofont.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/17.0.13/css/intlTelInput.css" />
    <link rel="stylesheet" href="{{asset('public/admin/')}}/dropify.min.css">
    <!-- Font Awesome -->
            ...
            <nav class="navbar header-navbar pcoded-header">
                <div class="navbar-wrapper">
                    <div class="navbar-logo">
                        ...
                        <a href="{{route('driver_dashboard')}}">
                        <img class="img-fluid" src="{{url($setting->footer_logo)}}" width="50px" alt="Theme-Logo" />
                        </a>
                  ...
                  <div class="navbar-container container-fluid">
                      ...
                      <ul class="nav-right">
                          ...
                          <?php
                                ...
                                ?>
                                    <img src="{{url($admin_image)}}" style="height: 40px; width: 40px;" class="img-radius" alt="User-Profile-Image">
                                ...
                                <ul class="show-notification profile-notification">
                                    ...
                                    <li class="waves-effect waves-light">
                                        <a href="{{route('driver_view_profile')}}">
                                            <i class="ti-user"></i> Profile
                                        </a>
                                    </li>
                                    <li class="waves-effect waves-light">
                                        <a href="{{route('driver_change_password')}}">

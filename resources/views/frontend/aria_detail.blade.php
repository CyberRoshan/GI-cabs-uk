...
<main class="main">
    ...
    <section class="section banner-home1 position-relative">
      <div class="position-absolute heroHeading">
        <h1 class="heading-52-medium AirportH1 text-md-start text-center mt-md-0 mt-5 pt-md-0 pt-5 color-white wow fadeInUp">Reliable Leicester Airport Taxi Services</h1>
        <p class="hero-para text-white fw-normal fs-5 w-75 d-md-block d-none lh-base"> Travel effortlessly with Leicester's premier airport taxi service. Whether you're heading to
          Birmingham, East Midlands, Luton, Manchester, Gatwick, Stansted, or Heathrow, our
          experienced drivers and modern fleet ensure a seamless and stress-free journey every time.</p>
      </div>
  ...
  <!-- Book Outstation Cabs from Airport -->
  <section class="section pt-65 pb-0">
    <div class="container-sub">
      <h2 class="heading-44-medium text-center wow fadeInUp mb-5 pb-5">Book Outstation Cabs from Airport</h2>
  ...
  <section class="section pt-65 pb-30 bg-faqs">
    <div class="container-sub">
      <div class="box-faqs">
        ...
        resources/views/frontend/aria_detail.blade.php      </h5>

...
<main class="main">
  ...
  <section class="section banner-home1 position-relative">
    <div class="position-absolute heroHeading">
      <h1 class="heading-52-medium AirportH1 text-md-start text-center mt-md-0 mt-5 pt-md-0 pt-5 color-white wow fadeInUp">Taxi from Leicester to <br> Birmingham International
        Airport</h1>
      <p class="hero-para text-white fw-normal fs-5 w-75 d-md-block d-none lh-base"> Travel effortlessly with GI Express Taxi. Our expert drivers ensure a seamless journey from
        Leicester to Birmingham International Airport, providing comfort and reliability every step of the
        way.</p>
    </div>

    <div class="box-cover-image" style="background-image: url('http://localhost/cabtaxi/cabtaxi/uploads/banner/75596.png')"></div>
  ...
  <!-- Birmingham International Airport Overview -->
  <section class="section pt-65 pb-0">
    <div class="container-sub">
      <h2 class="heading-44-medium text-center wow fadeInUp mb-5 pb-5">Birmingham International Airport Overview</h2>
      <div class="row gap-lg-0 gap-3 align-items-lg-center">
        ...
        <div class="col-12 py-md-5 py-2">
          <div class="row justify-content-xl-center">
            <div class="col-12">
              <div>
                <p class="mb-5 pb-5 aboutPara lh-base"> Birmingham International Airport, located just 8 miles southeast of Birmingham city center, is
                  one of the UK's major aviation hubs. Serving millions of passengers annually, it offers a wide
                  range of domestic and international flights, connecting Leicester to destinations across Europe,
                  Asia, North America, and beyond.
                </p>
                <p class="mb-5 aboutPara lh-base"> The airport boasts modern facilities, including numerous dining and shopping options,
                  comfortable lounges, and efficient passenger services to ensure a smooth travel experience.
                  Whether you're departing for a business meeting or returning from a holiday, Birmingham
                  International Airport provides the convenience and connectivity you need for seamless journeys.</p>
              </div>
            </div>
          </div>
        </div>
        <div class="col-12 row  d-flex align-items-center justify-content-lg-start justify-content-center gap-lg-0 gap-3 ">
          <div class="col-lg-6 col-12">
            <img class="img-fluid" src="http://localhost/cabtaxi/cabtaxi/uploads/fleet/banner/93385.png" alt="">
          </div>
          <div class="col-lg-6 col-12">
            <div>
              <div class="mb-5 pb-5">
                <h3 class="cardTitle fs-H3  mb-10">Leicester to Birmingham Airport
                  Distance</h3>
                <p class=" fs-20 color-text mb-10">Approximately 60 miles (96 kilometers) from
                  Leicester to Birmingham International Airport.</p>
              </div>
              <div class="">
                <h3 class="cardTitle fs-H3  mb-10">Estimated Travel Time</h3>
                <p class=" fs-20 color-text mb-10">Typically takes around 1 hour and 15 minutes,
  ...
  <!-- How to Book? -->
  <section class="section pt-120 pb-30">
    <div class="container-sub">
      <div class="text-center">
      ...
      <div class="d-flex flex-lg-row flex-column align-items-center justify-content-between gap-5 py-5">
        <div class="cardWork px-3 text-center">
          ...
          <div class="cardTitle">
            <h3 class="text-23-semibold color-text">Choose Your Service</h5>
          </div>
        </div>
        <div class="cardWork px-3 text-center">
          <div class="d-flex justify-content-center pb-3">
  ...
  <!--  Book Cabs from Leicester to the Airport! -->
  <section class="section pt-65 pb-0">
    <div class="container-sub">
      <h2 class="heading-44-medium text-center wow fadeInUp mb-5 pb-5"> Book Cabs from Leicester to the Airport!</h2>
      <div class="row gap-lg-0 gap-3 align-items-lg-center">
  ...
  <!-- Travel Tips for Leicester to Birmingham International Airport -->
  <section class="section pt-65 pb-30">
    <div class="container-sub">
      <div class="">
        ...
        <div class="mt-60 mb-40" id="accordionFAQ">
            ...
            <div class="accordion-item">
              <h3 class="accordion-header" id="headingOne">
                <button class="accordion-button text-heading-5" type="button" data-bs-toggle="collapse"
                  ...
                  <div class="num-red fw-bolder"> 1. &nbsp;</div> Book Your Taxi in Advance
                </button>
              </h3>
              <div class="accordion-collapse collapse show" id="collapseOne" aria-labelledby="headingOne" data-bs-parent="#accordionFAQ">
                <div class="accordion-body">
                  Reserve your taxi ahead of time, especially during peak travel seasons or early morning and
                  late-night flights, to guarantee availability and avoid last-minute hassles.
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="accordion-item">
              <h3 class="accordion-header" id="headingTwo">
                <button class="accordion-button text-heading-5" type="button" data-bs-toggle="collapse"
                  ...
                  <div class="num-red fw-bolder">2. &nbsp;</div> Allow Extra Time for Traffic
                </button>
              </h3>
              <div class="accordion-collapse collapse " id="collapseTwo" aria-labelledby="headingTwo" data-bs-parent="#accordionFAQ">
                <div class="accordion-body">
                  Travel times can vary, especially during rush hours (7:00 AM- 9:00 AM and 4:00 PM- 7:00 PM).
                  Plan to leave earlier to account for potential traffic delays.
                  <br>
                  Weather Conditions: Inclement weather such as rain or snow can impact travel time. Check the
                  weather forecast and allow additional time if necessary.
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="accordion-item">
              <h3 class="accordion-header" id="headingThree">
                <button class="accordion-button text-heading-5" type="button" data-bs-toggle="collapse"
                  ...
                  <div class="num-red fw-bolder"> 3. &nbsp; </div> Prepare for Your Flight
                </button>
              </h3>
              <div class="accordion-collapse collapse " id="collapseThree" aria-labelledby="headingThree" data-bs-parent="#accordionFAQ">
                <div class="accordion-body">
                  Check-In Online: Save time by checking in online before your departure. This allows you to
                  head straight to security without waiting in long lines at the airport.
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="accordion-item">
              <h3 class="accordion-header" id="headingFour">
                <button class="accordion-button text-heading-5" type="button" data-bs-toggle="collapse"
                  ...
                  <div class="num-red fw-bolder"> 4. &nbsp;</div> Communicate Your Flight Details
                </button>
              </h3>
              <div class="accordion-collapse collapse " id="collapseFour" aria-labelledby="headingFour" data-bs-parent="#accordionFAQ">
                <div class="accordion-body">
                  Flight Information: Inform your driver of your flight details, including departure time and airline,
                  so they can monitor any changes and adjust your pickup time accordingly.
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="accordion-item">
              <h3 class="accordion-header" id="headingFive">
                <button class="accordion-button text-heading-5" type="button" data-bs-toggle="collapse"
                  ...
                  <div class="num-red fw-bolder"> 5. &nbsp;</div> Utilize Airport Facilities
                </button>
              </h3>
              <div class="accordion-collapse collapse " id="collapseFive" aria-labelledby="headingFive" data-bs-parent="#accordionFAQ">
                <div class="accordion-body">
                  Meet and Greet Service: If you’re arriving at Birmingham International Airport, consider our meet
                  and greet service where a driver will assist you with your luggage and guide you to your
                  transportation.
                </div>
              </div>
            </div>
            ...
            <div class="accordion-item">
              <h3 class="accordion-header" id="headingSix">
                <button class="accordion-button text-heading-5" type="button" data-bs-toggle="collapse"
                  ...
                  <div class="num-red fw-bolder"> 6. &nbsp;</div> Stay Connected
                </button>
              </h3>
              <div class="accordion-collapse collapse " id="collapseSix" aria-labelledby="headingSix" data-bs-parent="#accordionFAQ">
                <div class="accordion-body">
                  Contact Information: Keep our contact details handy in case you need to reach out for any
                  assistance or updates regarding your transfer.
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="accordion-item">
              <h3 class="accordion-header" id="headingSeven">
                <button class="accordion-button text-heading-5" type="button" data-bs-toggle="collapse"
                  ...
                  <div class="num-red fw-bolder"> 7. &nbsp;</div> Safety First
                </button>
              </h3>
              <div class="accordion-collapse collapse " id="collapseSeven" aria-labelledby="headingSeven" data-bs-parent="#accordionFAQ">
                <div class="accordion-body">
                  Health Precautions: Our vehicles are regularly sanitized, and drivers adhere to strict hygiene
                  protocols to ensure your safety and well-being.
                  <br>
                  Secure Belongings: Always keep your personal belongings secure and within sight during the
                  journey.
            ...
            <div class="accordion-item">
              <h3 class="accordion-header" id="headingEight">
                <button class="accordion-button text-heading-5" type="button" data-bs-toggle="collapse"
                  ...
                  <div class="num-red fw-bolder"> 8. &nbsp;</div> Cost Management
                </button>
              </h3>
              <div class="accordion-collapse collapse " id="collapseEight" aria-labelledby="headingEight" data-bs-parent="#accordionFAQ">
                <div class="accordion-body">
                  Transparent Pricing: Take advantage of our competitive and transparent pricing with no hidden
                  fees. Review the fare estimate before booking to manage your travel budget effectively
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="accordion-item">
              <h3 class="accordion-header" id="headingNine">
                <button class="accordion-button text-heading-5" type="button" data-bs-toggle="collapse"
                  ...
                  <div class="num-red fw-bolder"> 9. &nbsp;</div> Enjoy the Ride
                </button>
              </h3>
              <div class="accordion-collapse collapse " id="collapseNine" aria-labelledby="headingNine" data-bs-parent="#accordionFAQ">
                <div class="accordion-body">
                  Comfort and Convenience: Relax and enjoy the ride in our well-maintained vehicles. Our
                  professional drivers are committed to providing a smooth and pleasant journey.
                </div>
              </div>
            </div>
          </div>
  ...
  <!-- Hire Leicester Taxis at Lowest Prices -->
  <section class="section pt-65 pb-0">
    <div class="container-sub">
      <h2 class="heading-44-medium text-center wow fadeInUp mb-5 pb-5">Hire Leicester Taxis at Lowest Prices</h2>
      <div class="row gap-lg-0 gap-3 align-items-lg-center">
        <div class="col-12 col-lg-6 col-xl-5">
          <img class="img-fluid rounded" loading="lazy" src="https://bootstrapbrain.com/demo/components/abouts/about-1/assets/img/about-img-1.jpg" alt="About 1">
        </div>
